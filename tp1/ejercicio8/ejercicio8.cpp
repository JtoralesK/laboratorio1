/*Ejercicio:8) Hacer un programa para ingresar por teclado el importe de una venta sin el descuento y el
...
int main(){
float isin, icon,porcentajeConDescuento,PorcentajeDescuentoSolo;
cout<<"ingresar venta sin el descuento:";
cin>>isin;
cout<<"ingresar venta con el descuento:";
cin>>icon;
porcentajeConDescuento=(icon*100)/isin;
PorcentajeDescuentoSolo=100-porcentajeConDescuento;
cout<<"el porcentaje del descuento es de:%"<<PorcentajeDescuentoSolo;
